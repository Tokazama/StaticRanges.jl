...
function checkbounds(A::StaticRange, I::SVal...)
    Base.@_inline_meta
...
checkbounds(::Type{Bool}, inds::StaticRange, i::Integer) =
    checkindex(Bool, sfirstindex(inds), slastindex(inds), i)

function checkbounds(::Type{Bool}, inds::StaticRange{T,SVal{L}}, I::AbstractArray{T2,N}) where {T,L,T2,N}
    Base.@_inline_meta
    b = true
    for i in I
...
checkindex(::Type{Bool}, inds::StaticRange, i::Real) =
